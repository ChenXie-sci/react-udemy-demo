    ...
    return (
      <div className="course-page rel">
            ...
            <div className="course-meta">
                <h2 className="s15 title fontb c333"> {course.title}</h2>
                <p className="s15 about fontn c777" dangerouslySetInnerHTML={{__html: course.about}} />
            </div>
            ...
            <div className="course-preview rel">
                <div className="player">
                    <video />
                    <div className="ctrls abs flex">
                       <button className="icon-pause pp" />
                       <div className="timer rel fontb s13">
                           02:54 / 09:55
                       </div>
                       ...
                       <button className="icon-full-screen-enter2 s24 ds" />
                    </div>
                </div>
